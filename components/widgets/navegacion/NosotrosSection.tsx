      ...
      <div  className="container px-5 py-2 mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className=" mb-[50px] text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-white">
            ...
            la pena celebrar la vida y ofrece un escenario para que todos los
            anhelos se conviertan en realidad. Desde 2009 hasta la actualidad
            hemos hecho posible más de 800 experiencias únicas que perdurarán
            para siempre en la memoria de quienes nos elijen. Evolucionamos en
            nuestras propuestas y servicios, siempre desde un espacio
            privilegiado tanto para reuniones sociales como corporativas.
          </p>
          <br id="servicios" />
          <br />
